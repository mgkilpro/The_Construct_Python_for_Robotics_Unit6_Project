...
class escape:
    ...
    def drive(self):                                                            #make move robot without crashing to wall
      ...
      while True:
        ...
        elif laserValue[sideLaser1] < radius - 0.15:                                   #right1 laser detected wall : direction of robot is worse than above case
        ...
        elif laserValue[719-sideLaser1] < radius - 0.15:
